# Cross-Agent Coordination — Codex (`codex`)

You (`agent_id = codex`) have been added to this project's AutoClaw
fleet. Your coordination role: **orchestrator**.
...
## Your mailbox
- Inbox:   .autoclaw/orchestrator/comms/inboxes/codex/
- Shared:  .autoclaw/orchestrator/comms/inboxes/shared/
- State:   .autoclaw/orchestrator/comms/inboxes/codex/_state/
- Done:    .autoclaw/orchestrator/comms/inboxes/codex/processed/

## Lifecycle (per cycle)
1. Write a heartbeat to
   .autoclaw/orchestrator/comms/heartbeats/codex.json
...
- keepalive_template: templates/keepalive/codex.md

When your heartbeat goes stale, the orchestrator's `/orchestrate revive
codex` renders that template (with your last task + stall duration)
